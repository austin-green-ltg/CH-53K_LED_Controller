...
TEST(Logger, WriteMultiple)
{
    ...
    ReadLog(address - strlen(expected) - 1, string, strlen(expected) + strlen(expected2) + 2 );
    TEST_ASSERT_EQUAL_UINT8_ARRAY("wm-test string\0wm-test2", string, strlen(expected) + strlen(expected2) + 2);
}
...
TEST(Logger, WriteRestart)
{
    ...
    ReadLog(address - strlen(expected2) - 1, string, strlen(expected) + strlen(expected2) + 2 );
    TEST_ASSERT_EQUAL_UINT8_ARRAY("wr-test2\0wr-test string", string, strlen(expected) + strlen(expected2) + 2);
}
