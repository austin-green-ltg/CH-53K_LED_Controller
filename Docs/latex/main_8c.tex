...
\begin{DoxyCompactList}\small\item\em The application entry point. Initialize variables and go into bare metal loop. Polls buttons and sensors. \end{DoxyCompactList}\end{DoxyCompactItemize}
